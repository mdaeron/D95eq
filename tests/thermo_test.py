	...
	for D47_coefs in (None, 0.99, 1.01):
		for D48_coefs in (None, 0.99, 1.01):
			...
			for D47, sD47, D48, sD48 in (
				...
				T, p = E.nearest_Teq(
					D47 = _cd.uarray([_uc.ufloat(D47, sD47), _uc.ufloat(D47+0.01, sD47)]),
					D48 = _cd.uarray([_uc.ufloat(D48, sD48), _uc.ufloat(D48+0.01, sD48)]),
				)
				print('nearest')
				print(T)
				print(p)
